interface DataModelQuestion {
  question: string,
  suggestedAnswers: string[]

}
interface DataContainerQuestions {
  technical: DataModelQuestion[],
  behavioural: DataModelQuestion[],
  personal: DataModelQuestion[],
  uncategorized?: DataModelQuestion[]
}

const questions: DataContainerQuestions = {
  "technical": [
    {
  ...
  "uncategorized": [
    ...
    {
      question: "yur personal pitch. Why should xxx hire you? What will you bring to the team?",
