duringInterview = {
    ...
    "introducing yourself": {
        "goals with introduction": [
            ...
            "communicate your journey, and where you are professionally",
            "communicate interests and who you are as a person"
        ],
        "key points": {
            ...
            "Key events/turning points in your life that pushed you in this direction": [
                "Everything relating to technology counts: hobbies when you were younger, dabbling with code,, "
                "online bootcamps, internships, interrupted studies, working in a technical environment etc.",
